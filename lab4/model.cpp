...
void Model::setBgColor(QColor &color)
{
    this->bgColor = color;
}
...
void Model::setMethod(method_t methode)
{
    this->methode = methode;
}

QColor Model::getBgColor()
{
    return bgColor;
}

QColor Model::getLineColor()
{
    return color;
}
...
void Model::addEllipses(const QPointF &center, double a, double b, double da, double db, int n)
{
...
const Ellipses &Model::getEllipses()
{
    return ellipses;
}

const Circles &Model::getCircles()
{
    return circles;
}
